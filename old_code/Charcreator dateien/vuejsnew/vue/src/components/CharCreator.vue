      ...
      <body>
        <div class="wrapper d-flex align-items-stretch">
          ...
          <div v-if="naviSwitch == 'Identität'" id="sidebar" class="p-4"
            ...
            <h1>
              <a class="logo" style="color:white">Identität</a>
            </h1>
            <ul class="list-unstyled components mb-5">
              ...
              <li class="active">
                ...
                <div>
                  <button type="button" class="btn"
                    :class="{ 'btn-primary': character.gender == 'Männlich', 'btn-secondary': character.gender != 'Männlich' }"
                    @click="setGender('Männlich')">
                    Männlich
                  </button>
                  <button type="button" class="btn ml-2"
                    :class="{ 'btn-primary': character.gender == 'Weiblich', 'btn-secondary': character.gender != 'Weiblich' }"
                    @click="setGender('Weiblich')">
                    Weiblich
                  </button>
                </div>
              </li>
              ...
              <li class="active">
                ...
                <input v-model="character.birth" type="text" class="form-control" maxlength="10">
              </li>
              <hr />
              <!-- Vorname -->
              <li class="active">
                <span class="fa fa-user mt-3 mr-2"></span>Vorname
                <input v-model="character.firstname" type="text" class="form-control" maxlength="16">
              </li>
              <!-- Nachname -->
              <li class="active">
                <span class="fa fa-user mt-3 mr-2"></span>Nachname
                <input v-model="character.lastname" type="text" class="form-control" maxlength="16">
              </li>
              <!-- Größe -->
              <li class="active">
                <span class="fa fa-align-center mt-3 mr-2"></span>Größe
                <input v-model="character.size" type="text" class="form-control" maxlength="9" placeholder="1m - 70cm">
              </li>
              <!-- Herkunft -->
              <li class="active">
              ...
              <li class="active mt-3">
                <span class="fa fa-tshirt mr-2"></span>Kleidung
                <br />
                <select v-model="character.clothingChoice" class="form-control">
          ...
          <div v-if="naviSwitch == 'Haare'" id="sidebar" class="p-4"
            style="margin-right: 0;margin-left:auto;background-color: #0084ff">
            <h1>
              <a class="logo" style="color:white">Haare/Bart</a>
            </h1>
            <ul class="list-unstyled components mb-5">
              <!-- Haarstil -->
              <li>
                <span class="contenttext">Haarstil</span>
                <input class="ml-3 slider" type="range" min="0" max="75" v-model="character.hair[0]"
                  @input="customize('hair', 0, character.hair[0])">
                <small class="ml-2">{{character.hair[0]}}</small>
                <hr />
              </li>
              <li>
                ...
                <div class="hair">
                  <ul class="hairColors-1">
                    <!-- Hier wird über das Array hairColors iteriert;
                        jeder Listeneintrag zeigt die entsprechende Farbe als Hintergrund -->
                    <li v-for="(hairColor, index) in hairColors" 
                        :key="hairColor" 
                        :style="{ background: hairColor }"
                        @click="customize('hair', 1, index)">
                    </li>
                  </ul>
                </div>
                <hr />
              ...
              <li>
                ...
                <div class="hair">
                  <ul class="hairColors-2">
                    <!-- Auch hier wird das gleiche Array genutzt – alternativ kannst du für eine Tönung ein anderes Array verwenden -->
                    <li v-for="(hairColor, index) in hairColors" 
                        :key="hairColor" 
                        :style="{ background: hairColor }"
                        @click="customize('hair', 2, index)">
                    </li>
                  </ul>
                </div>
                <hr />
              </li>
              <!-- Bart wird nur angezeigt, wenn Geschlecht Männlich -->
              <li v-if="character.gender == 'Männlich'">
                <span class="contenttext">Bartstil</span>
                <input class="ml-3 slider" type="range" min="0" max="28" v-model="character.beard[0]"
                  @input="customize('beard', 0, character.beard[0])">
                <small class="ml-2">{{character.beard[0]}}</small>
                <hr />
              </li>
          ...
          <!-- <div v-if="naviSwitch == 'Haare'" id="sidebar" class="p-4"
            ...
            <ul class="list-unstyled components mb-5">
              ...
              <li>
                <span class="contenttext">Bartstil</span>
                <input class="ml-3 slider" type="range" min="0" max="28" value="1" v-model="character.beard[0]"
    ...
    data() {
      return {
        character: {
          ...
          clothingChoice: "Casual", // Standardwert setzen
